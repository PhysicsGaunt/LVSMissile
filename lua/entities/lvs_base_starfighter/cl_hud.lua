...
function ENT:LVSHudPaint( X, Y, ply )
	...
	self:PaintCrosshairCenter( HitPlane , Color(255,0,0,255))
	self:PaintCrosshairOuter( HitPilot , Color(255,0,0,255))

	if ply:lvsMouseAim() and not ply:lvsKeyDown( "FREELOOK" ) then
		self:LVSHudPaintMouseAim( HitPlane, HitPilot , Color(255, 0, 0 , 255))
	end
...
function ENT:LVSHudPaintMouseAim( HitPlane, HitPilot, Col )
